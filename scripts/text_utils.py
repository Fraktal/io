...
"""
#Source idea and template ipynb notebook for Senior Project is http://nbviewer.ipython.org/gist/ellisonbg/3837783/TwitterNetworkX.ipynb
#Edited by Shawn T Ervin 
